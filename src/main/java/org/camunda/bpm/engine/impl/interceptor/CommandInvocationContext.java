...
//        AtomicOperation operation = invocation.getOperation();
//        ExecutionEntity execution = invocation.getExecution();
//        String id = execution.getActivity().getId();
//        String canonicalName = operation.getCanonicalName();
//        if(canonicalName.equals("transition-notify-listener-take")){
//            String s = "";
//        }
//        if(canonicalName.equals("activity-execute")){
//            String s = "";
//        }
////        log.info("执行操作名称: : {} {}", id, canonicalName);
//        try {
